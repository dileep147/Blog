    ...
    <p class="post-create-form-title text-primary"><i class="fas fa-camera"></i>Pending Post</p>
    ...
    <div class="col-xs-4" style="text-align: center;">
        ...
        <div class="form-group">
             ...
             <div class="col-xs-12 col-sm-12">
                <div class="clearfix">
            <input type="text" name="title" readonly placeholder="Title" class="form-title-input form-control-plaintext" value="<?php echo set_value('title', $result->title); ?>">
        </div>
    </div>
        </div>
        <div class="form-group">
                    ...
                    <?php
                        foreach($main_categories as $data){ 
                            if ($data->id==$result->cat_id){
                                ?><option readonly  selected value=<?php echo $data->id; ?>><?php echo $data->name; ?></option><?php
                            }else{
                                ?><?php
                        }
                    } ?>
        ...
        <div class="form-group">
            <label class="control-label col-xs-3 col-sm-3 no-padding-right">Content</label>
             <div class="col-xs-12 col-sm-12">
                <div class="clearfix">
            <textarea name="content" id="" cols="30" rows="10" class="form-content-input" placeholder="Content" readonly><?php echo $result->content;?></textarea>
